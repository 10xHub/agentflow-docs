...
- [Add a tool](/docs/beginner/add-a-tool) — wrap any retriever as a tool the agent can call
- [Memory and store](/docs/concepts/memory-and-store) — persistence patterns for agent state
