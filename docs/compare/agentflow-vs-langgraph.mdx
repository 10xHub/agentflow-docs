...
<VsBanner
  ...
  tagline="Same graph mental model. Production server, durable threads, and a typed TypeScript client out of the box."
/>
...
<RelatedDocs docs={[
  ...
  {to: '/docs/concepts/state-graph', title: 'State graphs', description: 'How nodes, edges, and routing work in AgentFlow.', intent: 'concept'},
  {to: '/docs/beginner/add-memory', title: 'Add memory and checkpointing', description: 'Same patterns LangGraph uses, with AgentFlow\'s persistence layer.', intent: 'tutorial'},
  {to: '/blog/langgraph-to-agentflow-migration', title: 'LangGraph → AgentFlow migration walkthrough', description: 'A diff-style port of a real ReAct agent + tool, then multi-agent handoff.', intent: 'blog'},
]} />
