...
- [Get started with AgentFlow](/docs/get-started) — first agent in a few minutes
- [Multi-agent handoff patterns](/docs/how-to/python/handoff-between-agents) — direct mapping of CrewAI hierarchical flows
- [Persistence and threads](/docs/concepts/checkpointing-and-threads) — how state survives across calls
