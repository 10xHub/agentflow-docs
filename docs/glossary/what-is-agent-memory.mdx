...
from agentflow.prebuilt.tools.memory_tools import save_memory, search_memory
...
The agent can then decide to save facts ("user prefers Python over JavaScript") and retrieve them in future sessions ("search_memory: what does the user prefer?").
